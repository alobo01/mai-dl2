#!/bin/bash
#
# HTCondor job script for Enhanced OSR experiments
# This script sets up the environment and runs a single experiment
#
...
JOB_OUTPUT_DIR="htcondor_outputs/job_${JOB_ID}_${CONFIG_NAME}"
...
echo "Command: python -m src.deep_osr.train --config-name $CONFIG_NAME trainer.max_epochs=$MAX_EPOCHS custom_output_dir=$JOB_OUTPUT_DIR"
